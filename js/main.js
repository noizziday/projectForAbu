    ...
    productsList.innerHTML += `
            <div class="card m-5" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-success btn-edit" id="${item.id}">EDIT</a>`
                        : ""
                    }
                </div>
            </div>
...
async function addCategoryToDropdownMenu() {
  ...
  categoriesList.innerHTML =
    '<li><a class="dropdown-item" href="#"><b>All</b></a></li>';
...
//update
let saveChangesBtn = document.querySelector(".save-cahnges-btn");
...
function checkCreateAndSaveBtn() {
  if (saveChangesBtn.id) {
    ...
    addproduct.setAttribute("style", "display:block;");
